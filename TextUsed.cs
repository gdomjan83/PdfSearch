...
namespace PdfSearcher {
    internal class TextUsed {
        ...
        public const string START_MONTH_PLACEHOLDER = "Hónaptól";
        public const string END_MONTH_PLACEHOLDER = "Hónapig";
        ...
        public const string HELP_TEXT = $"A {WINDOWS_TITLE} alkalmazás segítségével a bérkarton pdf fájlokban lehetőség van neveket keresni," +
            ...
            $"2. Lehetőség van egyszerre több hónap bérkartonjában is keresni. Ehhez a kezdő hónapot és a záró hónapot is be kell írni." +
            $" Ha csak egy hónapban akarunk keresni, akkor elegendő a kezdő hónapot beírni.\n\n" +
            $"3. A keresett nevek ablakba beírni, vagy bemásolni azokat a neveket, amelyekhez az oldalszámokat meg kívánjuk kapni. Az alkalmazás " +
            $"képes több név keresésére. Minden névnek külön sorban kell szerepelnie.\n\n" +
            $"4. Az alkalmazás ablakának alján látható az az elérési útvonal, ahol a bérkarton fájloknak lennie kell. Ha ez megváltozik, akkor " +
            $"át kell írni az elérési útvonalat is. A fájlok neveinek a következő formátumban kell lennie: 2025.09\n\n" +
            $"5. A keresés indítása gommbal indítható a keresés.\n\n" +
            $"6. A visszaállítás gombbal kitörölhetjük a megadott adatokat.\n\n" +
            $"7. Az eredmény ablakban tájékozatást kap a felhasználó arról, hogy a megadott név megtalálható volt-e a bérkarton " +
            $"fájlban, illetve megjelennek azok az oldalszámok, amelyeken a dolgozók szerepelnek a bérkarton fájlban.\n\n" +
            $"8. A művelet végén a megkapott oldalszámokhoz tartozó oldalak egy külön PDF fájlban elmentésre kerülnek a " +
            $"Dokumentumok/lapolvasás mappában.\n\n" +
            $"9. A Lapolvasás mappa megnyitható a Mentés mappa megnyitása gomb használatával.";
